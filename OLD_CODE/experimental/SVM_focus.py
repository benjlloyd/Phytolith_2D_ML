...
train_images, train_labels = ld.loadTrainData('/Users/jessicaperry/Dropbox', imageStyle = 'focus_stacking_images')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_iamges,) shaped np array
test_images, test_labels = ld.loadTestData('/Users/jessicaperry/Dropbox', imageStyle = 'focus_stacking_images') #essentially has the same behavior with loadTrainData but loads testing data
...
#Accuracy 68.3, 70, 68.3, 50, 70, 85, 68.3, 50, 70, 83.3, 78.3, 66.7, 70, 83.3, 76.7, 75, 70, 83.3, 76.7, 76.7
#Best precision, training accuracy for C=10000 gamma=.01 test accuracy 83.3
#Best recall for C=10, gamma=.01 test accuracy 85