...
train_images, train_labels = ld.loadTrainData('/Users/jessicaperry/Dropbox', imageStyle = 'global_autocontrast_normalized')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_iamges,) shaped np array
test_images, test_labels = ld.loadTestData('/Users/jessicaperry/Dropbox', imageStyle = 'global_autocontrast_normalized') #essentially has the same behavior with loadTrainData but loads testing data
...
#50, 73.3, 50, 50, 51.7, 81.7, 73.3, 50, 51.7, 81.7, 83.3, 71.7, 51.7, 81.7, 76.7, 75, 51.7, 81.7, 76.7, 71.7
#Best precision, recall, training accuracy for C=10 gamma=.01 test accuracy 81.7
#Best C=100 gamma=.001 test accuracy 83.3 