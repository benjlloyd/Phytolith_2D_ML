...
train_images, train_labels = ld.loadTrainData('/Users/jessicaperry/Dropbox', imageStyle = 'median_images')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_iamges,) shaped np array
test_images, test_labels = ld.loadTestData('/Users/jessicaperry/Dropbox', imageStyle = 'median_images') #essentially has the same behavior with loadTrainData but loads testing data
...
#Accuracy 88.3, 70, 68.2, 50, 90, 88.3, 68.3, 50, 91.7, 90, 83.3, 68.3, 91.7, 90, 85, 78.3, 91.7, 90, 81.7, 80
#Best precision, recall, training accuracy for C=10000 gamma=.01 test accuracy 90%
#Best test accuracy for C=10,000, 1000, 100 gamma=.1 91.7