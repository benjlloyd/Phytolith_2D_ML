...
train_images, train_labels = ld.loadTrainData('/Users/jessicaperry/Dropbox', imageStyle = 'mean_images')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_iamges,) shaped np array
test_images, test_labels = ld.loadTestData('/Users/jessicaperry/Dropbox', imageStyle = 'mean_images') #essentially has the same behavior with loadTrainData but loads testing data
...
#Accuracy 86.7, 68.3, 68.3, 50, 90, 88.3, 68.3, 50, 91.7, 91.7, 86.7, 68.3, 91.7, 91.7, 85, 75, 91.7, 91.7, 86.7, 80
#Best precision, recall, and training accuracy for C= 10000, gamma=.01 test accuracy 91.7%