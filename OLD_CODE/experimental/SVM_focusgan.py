...
train_images, train_labels = ld.loadTrainData('/Users/jessicaperry/Dropbox', imageStyle = 'focus_stacking_global_autocontrast_normalized')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_iamges,) shaped np array
test_images, test_labels = ld.loadTestData('/Users/jessicaperry/Dropbox', imageStyle = 'focus_stacking_global_autocontrast_normalized') #essentially has the same behavior with loadTrainData but loads testing data
...
#50, 73.3, 50, 50, 50, 81.7, 70, 50, 50, 81.7, 80, 73.3, 50, 81.7, 80, 75, 50, 81.7, 80, 70
#Best precision for C=1 gamma=.01 test accuracy 73.3
#Best recall, training accuracy for C=10 gamma=.01 test accuracy 81.7