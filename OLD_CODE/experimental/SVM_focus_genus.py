...
train_images, train_labels, train_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/focus_stacking_images', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_train.txt')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_images,) shaped np array
test_images, test_labels, test_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/focus_stacking_images', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_test.txt') #essentially has the same behavior with loadTrainData but loads testing data
...
#35.0, 30.1, 17.5, 4.9, 38.8, 45.9, 30.1, 19.1, 37.8, 47.0, 45.4, 30.6, 38.3, 45.9, 47.5, 42.6, 38.3, 46.4, 46.4, 44.3
#Best precision, recall, train accuracy for C=10000 gamma=.01 Test Accuracy 46.4
#Best Test Accuracy 47.5% for C= 1000 gamma=0.001