...
train_images, train_labels = ld.loadTrainData('/Users/jessicaperry/Dropbox', imageStyle = 'mean_global_autocontrast_normalized')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_iamges,) shaped np array
test_images, test_labels = ld.loadTestData('/Users/jessicaperry/Dropbox', imageStyle = 'mean_global_autocontrast_normalized') #essentially has the same behavior with loadTrainData but loads testing data
...
#50, 68.3, 50, 50, 51.7, 83.3, 75, 50, 51.7, 83.3, 80, 71.7, 51.7, 83.3, 75, 76.7, 51.7, 83.3, 75, 70
#Best precision for C=10 gamma=.001 test accuracy 75
#Best recall, training accuracy for C=10 gamma=.01 test accuracy 83.3
