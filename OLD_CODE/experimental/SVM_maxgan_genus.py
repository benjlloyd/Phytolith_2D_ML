...
train_images, train_labels, train_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/max_global_autocontrast_normalized', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_train.txt')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_images,) shaped np array
test_images, test_labels, test_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/max_global_autocontrast_normalized', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_test.txt') #essentially has the same behavior with loadTrainData but loads testing data
...
#23.0, 45.4, 18.0, 7.1, 24.0, 54.6, 49.7, 18.0, 23.5, 54.6, 51.9, 48.6, 23.5, 54.6, 52.5, 51.4, 23.5, 54.6, 51.9, 50.8
#Best precision, recall, training accuracy for C=10 gamma=.01 Test Accuracy 54.6%
#Best test accuracy also for C= 100, 1000, 10000 gamma=0.01