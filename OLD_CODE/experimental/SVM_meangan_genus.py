...
train_images, train_labels, train_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/mean_global_autocontrast_normalized', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_train.txt')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_images,) shaped np array
test_images, test_labels, test_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/mean_global_autocontrast_normalized', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_test.txt') #essentially has the same behavior with loadTrainData but loads testing data
...
#28.4, 42.1, 9.3, 4.9, 30.1, 54.6, 42.1, 10.9, 30.1, 54.6, 52.5, 41.0, 30.1, 54.6, 52.5, 51.9, 30.1, 54.6, 52.5, 51.9
#Best precision, training accuracy for C=10 gamma=.01 Test Accuracy 54.6%
#Best recall for C=1000 gamma=.0001 Test Accuracy 51.9%
#Best test accuracy also for C=100, 1000, 10000 gamma=.01
