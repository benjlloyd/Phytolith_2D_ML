...
train_images, train_labels, train_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/focus_stacking_global_autocontrast_normalized', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_train.txt')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_images,) shaped np array
test_images, test_labels, test_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/focus_stacking_global_autocontrast_normalized', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_test.txt') #essentially has the same behavior with loadTrainData but loads testing data
...
#24.0, 38.8, 14.2, 4.9, 26.2, 45.9, 39.3, 14.8, 26.2, 45.9, 45.4, 39.3, 26.2, 45.9, 45.4, 43.7, 26.2, 45.9, 45.4, 43.7
#Best precision, recall and train accuracy for C=10 gamma=.01 Test Accuracy 45.9%
