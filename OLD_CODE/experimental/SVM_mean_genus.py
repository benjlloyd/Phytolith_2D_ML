...
train_images, train_labels, train_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/mean_images', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_train.txt')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_images,) shaped np array
test_images, test_labels, test_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/mean_images', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_test.txt') #essentially has the same behavior with loadTrainData but loads testing data
...
#45.9, 25.7, 18.0, 6.6, 53.6, 52.5, 25.1, 18.0, 51.9, 56.3, 53.6, 26.2, 53.0, 54.6, 55.7, 53.6, 51.9, 55.2, 55.2, 55.7
#Best precision, recall, training accuracy for C=10000 gamma=.01 Test Accuracy 55.2%
#Best Test accuracy 56.3 for C=100 gamma=.01