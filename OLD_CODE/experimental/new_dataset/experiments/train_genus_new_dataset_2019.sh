...
--train_list_file "../../../data/new_dataset_2019/genus_train.txt" \
--validation_list_file "../../../data/new_dataset_2019/genus_validation.txt" \
--test_list_file "../../../data/new_dataset_2019/genus_test.txt" \
--granularity genus \
--vis_tag "_${name}-${tag}" \
${@:3} | tee "${log_file}"
