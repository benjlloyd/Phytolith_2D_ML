...
train_images, train_labels, train_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/max_images', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_train.txt')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_images,) shaped np array
test_images, test_labels, test_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/max_images', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_test.txt') #essentially has the same behavior with loadTrainData but loads testing data
...
#48.1, 27.3, 16.9, 4.9, 54.1, 54.1, 26.2, 15.8, 54.1, 55.7, 51.4, 24.6, 54.6, 55.7, 54.6, 50.3, 54.6, 56.3, 54.6, 52.5
#Best precision, recall, training accuracy for C=10000 gamma=.01 Test Accuracy 56.3%
