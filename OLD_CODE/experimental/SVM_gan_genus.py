...
train_images, train_labels, train_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/global_autocontrast_normalized', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_train.txt')
    #"images" are (num_of_images, size, size) shaped np array, "labels" are (num_of_images,) shaped np array
test_images, test_labels, test_tribe = gl.load('/Users/jessicaperry/Dropbox/phytoliths/global_autocontrast_normalized', list_file = '/Users/jessicaperry/Dropbox/phytoliths/genus_test.txt') #essentially has the same behavior with loadTrainData but loads testing data
...
#27.9, 39.9, 9.8, 4.9, 30.1, 50.8, 37.2, 10.9, 30.1, 50.8, 50.8, 36.1, 30.1, 50.8, 50.8, 48.1, 30.1, 50.8, 50.8, 48.6
#Best precision for C=1000 gamma=.001 Test Accuracy 50.8%
#Best recall for C=100 gamma=.001 Test Accuracy 50.8%
#Best train accuracy for C=10 gamma=.01 Test Accuracy 50.8%
#Best Test Accuracy also for C=100, 1000, 10000 gamma=.01, C=10000 gamma=.001